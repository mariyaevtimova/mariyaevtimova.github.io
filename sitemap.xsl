...
<html>
<head>
<title>Sitemap <xsl:if test="sitemap:sitemapindex">Index</xsl:if></title>
<link rel="stylesheet" href="https://unpkg.com/tachyons@4.6.1/css/tachyons.min.css"/>
</head>
<body class="ph3 pb3 mid-gray">
<header class="mw8 pv4 center">
<div class="flex items-center">
<h3 class="ma0 mr2 f2">Sitemap</h3>
...
This index contains <strong class="blue"><xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"/></strong> sitemaps.
</xsl:when>
<xsl:otherwise>
This index contains <strong class="blue"><xsl:value-of select="count(sitemap:urlset/sitemap:url)"/></strong> URLs.
</xsl:otherwise>
</xsl:choose>
</h3>
<p>This is an XML sitemap of <a href="{{ site.url }}" title="{{ site.title }}" class="link blue">{{ site.url }}</a>, meant for consumption by search engines.</p>
</header>
<xsl:apply-templates/>
<footer class="mw8 center pv4 tc">
Go back to the <a href="{{ site.url }}" title="Go back to the homepage" class="link blue">homepage</a>.
</footer>
</body>
</html>
</xsl:template>
